<template>
	<div class="login" v-if="showModel">
		<van-form @submit="onSubmit">
			...
			<div style="margin: 30px 0 0;"><van-button block type="info" native-type="submit">登录</van-button></div>
		</van-form>
	</div>
</template>
	...
	data() {
		return {
			avatar: [
				...
				{
					avatar: require('../../static/img/7.jpg'),
					name: '7'
				},
				{
					avatar: require('../../static/img/6.jpg'),
					name: '6'
				},
				{
				...
				{
					avatar: require('../../static/img/4.jpg'),
					name: '4'
				},
				{
					avatar: require('../../static/img/3.jpg'),
					name: '3'
				},
				{
